...
DEBIAN_FRONTEND=noninteractive apt install -y --reinstall --option Dpkg::Options::="--force-confold" libc6-dev-armhf-cross gcc-arm-linux-gnueabihf binutils-arm-linux-gnueabihf
